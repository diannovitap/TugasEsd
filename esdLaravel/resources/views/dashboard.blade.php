...
<head>
	...
	<!-- GOOGLE FONTS -->
	<link href="{{asset('style/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700')}}" rel="stylesheet">
	<!-- ICONS -->
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html"><img src="{{asset('style/assets/img/logo-dark.png')}}" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset('style/assets/img/user.png')}}" class="img-circle" alt="Avatar"> <span>Dian Novita</span></a>
						</li>
						<!-- <li>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<p class="center-block"><img src="{{asset('style/assets/img/user-medium.png')}}" class="centered" width="60"></a></p>
              	  		<h5 class="centered">Dian Novita</h5>
						<li><a href="/dashboard" class="active"><span>Dashboard</span></a></li>
						<li><a href="/peminjam" class=""><span>Data Peminjam</span></a></li>
						<li><a href="/ruangan" class=""><span>Data Ruangan</span></a></li>
						<li><a href="/login" class=""><span>Logout</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
